...
<body id="page-top">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php  
                                                 ...
                                                 $mysqli     = mysqli_connect($host, $user, $password, $database);
                                                    ...
                                                    $sql = "SELECT COUNT(Location_id) as jumlah_lokasi from dim_location";
    ...
    <script type="text/javascript">
        ...
        $bulan = "SELECT CONCAT(MONTHNAME(t.Tanggallengkap), ' ', YEAR(t.date)) month FROM fakta_prd f 
                  JOIN dim_time t ON f.Time_id=t.Time_id GROUP BY t.Bulan 
                  ORDER BY t.Tanggallengkap";
        $product = "SELECT COUNT(f.Product_id) dim_product FROM fakta_product f 
                    JOIN dim_time t ON f.Time_id=t.Time_id GROUP BY t.Bulan 
                    ORDER BY t.Tanggallengkap";
        $i=1;
