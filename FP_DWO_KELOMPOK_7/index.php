...
<head>
    ...
    <title>DWOFINAL - Dashboard</title>
                                        ...
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php  
                                                 ...
                                                 $sql = "SELECT SUM(Quantity) as total_product from fakta_product";
                                                 $query = mysqli_query($mysqli,$sql);
                                                 while($row2=mysqli_fetch_array($query)){
                                                    echo "$".number_format($row2['total_product'],0,".",",");
                                                 }
                                                ?>  
                                                </div>
                                        </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <?php  
                                                 ...
                                                 $database   = "dwofinal2";
                                                 $mysqli     = mysqli_connect($host, $user, $password, $database);
                                            $sql = "SELECT SUM(OrderQty) as Total_Purchase from fakta_purchaseorder";
                                            $query = mysqli_query($mysqli,$sql);
                                                 while($row2=mysqli_fetch_array($query)){
                                                    echo number_format($row2['Total_Purchase'],0,".",",");
                                                 }
                                            ?>
                                            </div>
                                        </div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Total Vendor
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                                    <?php
                                                    $sql = "SELECT SUM(Vendor_id) as jumlah_vendor from dim_vendor";
                                                     $query = mysqli_query($mysqli,$sql);
                                                        while($row2=mysqli_fetch_array($query)){
