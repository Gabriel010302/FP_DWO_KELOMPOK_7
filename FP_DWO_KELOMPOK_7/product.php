...
<body id="page-top">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php  
                                                 ...
                                                 $mysqli     = mysqli_connect($host, $user, $password, $database);
                                                    ...
                                                    $sql = "SELECT COUNT(Product_id) as jumlah_prod from fakta_product";
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php  
                                            $sql = "SELECT COUNT(p.Product_id) as jml_product FROM fakta_product p
    ...
    <script type="text/javascript">
        ...
        $bulan = "SELECT CONCAT(MONTHNAME(t.Tanggallengkap), ' ', YEAR(t.Tanggallengkap)) Bulan FROM fakta_product f 
                  JOIN dim_time t ON f.Time_id=t.Time_id GROUP BY t.Bulan 
                  ORDER BY t.Tanggallengkap";
        $product = "SELECT COUNT(f.product_id) product FROM fakta_product f 
                    JOIN dim_time t ON f.Time_id=t.Time_id GROUP BY t.Bulan
                    ORDER BY t.Tanggallengkap";
        $i=1;
